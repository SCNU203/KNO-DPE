...
with open('/home1/caojie/knowledgepoints/mia_train/best_with.pickle', 'rb') as f:
    bc = pickle.load(f)
...
class Encoder(Model):
    def __init__(self,
        ...
        # self.add_dropout = nn.Dropout(0.15)#44:0.2 1   43:0.3  0
...
class SimpleSeq2Seq(Model):
    ...
    def forward(self,  # type: ignore
                image, source_nums, choice_nums, label, type, data_id, manual_program,formal_point,
        ...
        if not self.training:
            ...
            if target_tokens and self._bleu:
                ...
                for b in range(bs):
                    ...
                    tem=[hypo]
                    if data_id[b]==1417:
                        print(tem,"ffffffffffffffffffffffffffffffffffffffffff")
                    if choice is None:
                        no_knt += 1
