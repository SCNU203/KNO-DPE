...
class SimpleSeq2Seq(Model):
    ...
    def __init__(self,
                 ...
                 #encoder=StackedSelfAttentionEncoder(input_dim=8, hidden_dim=9, projection_dim=128,
        ...
        print(self._encoder_output_dim,"ggggggggggg")
        ...
        if self._attention:
            ...
            #print(self._decoder_input_dim,"gggggggggggggggggggggggggggggggg")1024
